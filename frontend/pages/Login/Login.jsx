  ...
  return (
    <section className="page auth-page">
      <header className="page__header">
        ...
        <p className="page__subtitle">Accedez a votre espace client Althea Medical.</p>
      </header>
      ...
      <form className="stack" onSubmit={handleSubmit} noValidate>
        ...
        {message ? (
          <div
            className={`notice ${message.toLowerCase().includes('reussie') ? 'notice--success' : 'notice--warning'}`}
            role="alert"
          >
            {message}
          </div>
        ...
        <div className="page-actions">
          ...
          <button className="btn btn--primary auth-action" type="submit" disabled={isSubmitting}>
